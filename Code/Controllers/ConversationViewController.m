...
- (id<ATLParticipant>)conversationViewController:(ATLConversationViewController *)conversationViewController participantForIdentifier:(NSString *)participantIdentifier
{
    ...
    NSString *currentUser = profile.userId;
    
    if ([participantIdentifier isEqualToString:currentUser]) return profile;
    A0UserProfile *user = [[UserManager sharedManager] cachedUserForUserID:participantIdentifier];
